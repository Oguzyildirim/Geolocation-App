...
import com.migros.geolocationapp.service.StoreService;
import com.migros.geolocationapp.util.HeaderUtil;
import com.migros.geolocationapp.util.PaginationUtil;
import com.migros.geolocationapp.util.ResponseUtil;
import com.migros.geolocationapp.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.migros.geolocationapp.domain.Store}.
 */
@RestController
@RequestMapping("/api")
public class StoreController {
    ...
    private static final String ENTITY_NAME = "storeserviceStore";
     ...
     */
    @GetMapping("/stores")
    public ResponseEntity<List<Store>> getStores(Pageable pageable) {
